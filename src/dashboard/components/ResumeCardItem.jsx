...
function ResumeCardItem({ resume, refreshData }) {
  ...
  return (
    <div>
      ...
      <div className='border p-3 flex justify-between items-center text-gray-800 rounded-b-lg shadow-lg' 
        style={{ background: 'white' }} // white background
      >
        <h2 className='text-lg font-medium'>{resume.title}</h2> {/* Dark text for title */}
        <DropdownMenu>
          <DropdownMenuTrigger>
            <MoreVertical className='h-4 w-4 cursor-pointer text-gray-800' /> {/* Dark color for icon */}
          </DropdownMenuTrigger>
          <DropdownMenuContent>
